...
class DiffPool(nn.Module):
    ...
    def __init__(self, num_features, num_classes, max_num_nodes, num_layers, gnn_hidden_dim,
        ...
        # final_embed_dim_output = gnn_embed_dim_output * (num_layers + 0)  # we get rid of embedding layer
    ...
    def forward(self, data):
        ...
        # cancel out the effect of GCN as much as possible
        ...
        # set loss component to be the same between diff_pool and capsule
        return x, torch.tensor(0.).cuda(), torch.tensor(0.).cuda()
