...
#from models.load_model import load_model as load_caps_conv
from model import load_caps_conv
...
def get_args():
    ...
    parser.add_argument('--out_dir', default='./caps_save/', type=str, help='Output directory')
...
def main():
    ...
    model = load_caps_conv(args).to(args.device)
    model.train()
    ...
    if args.resume is None: args.resume = save_file
